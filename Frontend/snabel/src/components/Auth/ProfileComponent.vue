              ...
              <div class="row justify-content-center align-items-center">
                ...
                <form class="mx-1 mx-md-4 m-auto" enctype="multipart/form-data" @submit.prevent="updateProfile">
                  ...
                  <div class="d-flex justify-content-between align-items-center mb-5">
                    ...
                    <div class="col-2">
                      <button class="btn btn-outline-secondary p-2 shadow" type="submit">Edit
                      </button>
                    </div>
                  </div>
                  <hr>
                  ...
                  <div class="row m-2">
                    <p>Deleting your account will remove all of your activity and campaigns, and you will no longer be
                      able to sign in with this account.</p>
                    <button class="btn btn-lg rounded auth-button btn-outline-danger" type="submit">Delete Account
                    </button>
                  </div>
                </form>
              </div>
