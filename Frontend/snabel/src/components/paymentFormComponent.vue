        ...
        <div class="col-lg-8 col-md-10 col-sm-12">
          ...
          >
            <div class="box d-flex py-3">
              <img
                src="https://media.istockphoto.com/id/1283030328/photo/silhouette-of-businessman-holding-target-board-on-the-top-of-mountain-with-over-blue-sky-and.jpg?s=612x612&w=0&k=20&c=2ZifINbmOZq9dWW8iviW1k275x2zDy8w5_TBuLB5Sso="
              />
              <p class="py-1 px-2">
                You're supporting <b>{{ project.user_name }}</b> which has
            ...
            <form class="row g-3 needs-validation" novalidate>
              ...
              <div v-if="selectedMethod === 'credit'" class="credit col-12">
                ...
                <div class="py-3">
                  ...
                  <label class="form-check-label" for="invalidCheck">
                    Save card for future donations</label
                  >
                </div>
              </div>
              <div class="col-12">
              ...
              <div class="col-12">
                <div>
                  <p class="my-3">
                    By choosing the payment method above, you agree to the
                    GoFundMe <a href="#">Terms of Service</a> and acknowledge
                    the <br />
                    <a href="#">Privacy Notice.</a> Learn more about
                    <a href="#">pricing and fees.</a>
                  </p>
                  <p class="my-5">
                    Certified Charity donations are made to PayPal Giving Fund,
                    <br />
                    <a href="#">minus transaction fees</a>, and granted within
                    <a href="#">15-45 days</a>, <br />
                    subject to its <a href="#">terms</a>. In the unlikely event
                    <a href="#"
                      >that there is a problem funding your chosen charity</a
                    >, PayPal Giving <br />
                    Fund will (whenever possible) ask you to recommend another,
                    <br />
                    and grant the funds to a similar charity if you don’t
                    respond. <br />
...
export default {
  ...
  methods: {
    collected() {
      if (
        this.project.total_target <
        this.project.total_target + this.donationAmount
      ) {
        this.donationAmount =
          this.project.total_target - this.project.total_target;
      } else {
    ...
    submitForm() {
      ...
      } else alert("Timeout: The project deadline has passed.");
    },
  },
  computed: {
    donationPercentage() {
